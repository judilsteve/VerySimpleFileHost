...
// 1. zxcvbn but there's no real way to make that smaller
// 2. semantic-ui-react (which imports a lot from lodash-es) - get rid of this entirely and I can drop preact-compat too
// 3. The autogenerated OpenAPI client
